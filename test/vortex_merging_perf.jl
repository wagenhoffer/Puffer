...
begin
    ...
    start = flow.N
    a = plot(t[start:end],
        coeffs_on[1, start:end],
        label = "Force off",
        lw = 3,
        marker = :none)
    plot!(a,
        t[start:end],
        coeffs_off[1, start:end],
        label = "Force on",
        lw = 0,
        marker = :circle)
    b = plot(t[start:end],
        coeffs_off[2, start:end],
        label = "Lift off",
        lw = 3,
        marker = :none)
    plot!(b,
        t[start:end],
        coeffs_on[2, start:end],
        label = "Lift on",
        lw = 0,
        marker = :circle)
    c = plot(t[start:end],
        coeffs_on[3, start:end],
        label = "Thrust off",
        lw = 3,
        marker = :none)
    plot!(c,
        t[start:end],
        coeffs_off[3, start:end],
        label = "Thrust on",
        lw = 0,
        marker = :circle)
    d = plot(t[start:end],
        coeffs_on[4, start:end],
        label = "Power off",
        lw = 3,
        marker = :none)
    plot!(d,
        t[start:end],
        coeffs_off[4, start:end],
        label = "Power on",
        lw = 0,
        marker = :circle)
